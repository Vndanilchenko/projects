...
df=pd.DataFrame({
    'класс':[1,
            ...
            6,
            7],
    'интент':['поприветствовать бота',
            'попрощаться с ботом',
            'узнать как дела',
            'услышать анекдот',
            'разослать информацию студентам на email',
            'узнать метеопрогноз на сегодня',
            'узнать расписание занятий',
            ],
    'реакция':['привет, я чат-бот, твой друг, задавай вопросы ;)',
            'с нетерпением жду снова в гости',
            'да все отлично, че сам как?',
            'пока не умею рассказывать анекдоты',
            'рассылка будет отправлена сразу, как научусь',
            'посмотри лучше в интернете, я еще не умею ее предсказать',
            'ты уже отучился, какие уроки',
            ]
            })
